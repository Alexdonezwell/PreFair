...
class PopupScatterSelection extends React.Component {
    ...
    getLevel(type,index){
        ...
        let target = clusterRate[type][index];;
        let arr = [];
